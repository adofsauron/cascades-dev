...
class MEMORY_MANAGER
{
 ...
 public:
  ...
  MEMORY_MANAGER(int block_anchor_count = INIT_BLOCK_ANCHOR_COUNT, int realloc_factor = DEFAULT_REALLOC_FACTOR);
  ...
  void *allocate(BLOCK_ANCHOR **anchor_v, int elem_size, int slots_per_block = DEFAULT_SLOTS_PER_BLOCK);
